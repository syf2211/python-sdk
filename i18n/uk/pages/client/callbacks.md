...
!!! info
    ...
    протокол. Фіксуйте `mode="legacy"` щоразу, коли клієнт має
...
Перший аргумент `Client(...)` визначає транспорт. Усі його різновиди описано на сторінці **[Транспорти клієнта](transports.md)**.
