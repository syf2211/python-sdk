...
!!! info
    ...
    протокол. Фиксируйте `mode="legacy"` всякий раз, когда клиент должен
...
Первый аргумент `Client(...)` выбирает транспорт. Все их виды описаны на странице **[Транспорты клиента](transports.md)**.
